...
Your crops won't die if you can't log in for a while. The server tracks crop ownership: unwatered crops get extra days instead of dying, and season-end death is delayed while you're offline. Normal rules apply once you return.

## Money

Servers can use shared (one pool for all) or separate wallets. Ask your admin which mode is active.
