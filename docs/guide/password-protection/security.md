...
- [Overview](/guide/password-protection/): quick setup and concepts
- [Lobby Layouts](/guide/password-protection/lobby-layouts): customize your lobby
- [Commands Reference](/guide/password-protection/commands): all lobby commands
- [Configuration Reference](/getting-started/configuration#password-protection): all settings in one place
