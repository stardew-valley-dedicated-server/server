...
public class DownloadValidationFixture : IAsyncLifetime
{
    ...
    private static readonly string VolumePrefix =
        Environment.GetEnvironmentVariable("SDVD_VOLUME_PREFIX") ?? "server";
