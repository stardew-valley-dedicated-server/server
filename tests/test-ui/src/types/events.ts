import type { OutputEntry, AnnotationLevel, AnnotationSource } from './state'
...
export interface InstanceStatusEvent {
  event: 'instance_leased' | 'instance_returned' | 'instance_disposed'
       | 'instance_poisoned' | 'instance_connected' | 'instance_disconnected'
