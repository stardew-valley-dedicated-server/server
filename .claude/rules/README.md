...
| `git-workflow.md` | Project-specific git rules (no `git add .`, no Co-Authored-By trailers, chained PRs, PR descriptions, build-before-`--continue` rebasing, worktrees at `../worktrees/` via the WorktreeCreate hook) |
